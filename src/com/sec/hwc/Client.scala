...
object Client {
  ...
  def main(args:Array[String]) {
    ...
    TimeServerObject.server.adjustTime(Util.getTime("2013-03-30 23:00"));
    TimeServerObject.server.adjustTime(Util.getTime("2013-03-31 03:00"));
    TimeServerObject.server.adjustTime(Util.getTime("2013-03-09 21:00"));
    TimeServerObject.server.adjustTime(Util.getTime("2013-03-10 01:00"));
    TimeServerObject.beijing.correctTime(Util.getTime("2013-03-10 5:00"));
